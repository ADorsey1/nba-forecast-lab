...
def attach_market_priors(forecast: pd.DataFrame, market: pd.DataFrame, *, now: datetime | None = None) -> pd.DataFrame:
    """Only matching, dated, fresh season/team priors may influence publication."""
